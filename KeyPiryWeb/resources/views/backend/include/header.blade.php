...
<header class="header">
    <div class="logo-container">
        <a href="{{route("backend.home.index")}}" class="logo">
            <img src="{{asset("assets/backend/img/logo.png")}}" width="75" height="35" alt="Porto Admin"/>
        </a>
                        ...
                        <ul>
                            <li>
                                <a href="#" class="clearfix">
                                    <figure class="image">
                                        <img src="{{asset("assets/backend/img/!sample-user.jpg")}}"
                            ...
                            <li>
                                <a href="#" class="clearfix">
                                    <figure class="image">
                                        <img src="{{asset("assets/backend/img/!sample-user.jpg")}}" alt="Joe Junior"
        ...
        <div id="userbox" class="userbox">
            <a href="#" data-toggle="dropdown">
                <figure class="profile-picture">
                    <img src="{{asset("assets/backend/img/!logged-user.jpg")}}" alt="Joseph Doe"
                         class="rounded-circle"
                         data-lock-picture="{{asset("assets/backend/img/!logged-user.jpg")}}"/>
                </figure>
